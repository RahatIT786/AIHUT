            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="navbar-nav d-lg-flex d-none">
                <li class="nav-item d-flex align-items-center">
                  <a class="btn btn-outline-primary btn-sm mb-0 me-2" target="_blank" >Online Builder</a>
                </li>
                <li class="nav-item">
                  <a  class="btn btn-sm mb-0 me-1 bg-gradient-dark">Free download</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a href="https://rahatitsolutions.com/" class="font-weight-bold text-white" target="_blank">Rahat IT Solutions</a>
                for a better web.
              </div>
            </div>
