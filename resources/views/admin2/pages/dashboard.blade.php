    ...
    <div class="container-fluid py-2">
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <a href="{{route('admin2.enquiry.list',['type'=>'signup'])}}" class="card">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <a href="{{route('admin2.enquiry.list',['type'=>'register'])}}" class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <a href="{{route('admin2.enquiry.list',['type'=>'contactus'])}}" class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
        ...
        <div class="col-xl-3 col-sm-6">
          <a href="{{route('admin2.enquiry.list',['type'=>'career'])}}" class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
