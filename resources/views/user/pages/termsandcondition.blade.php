					...
					<div class="elementor-widget-container">
						...
						<div class="tts text-left">
							<div class="ttin">
								...
								<!-- title middle -->
																<h2 class="txbdstitle sttwo hlight">Can this Membership be forfeited? <span></span> </h2>
                                                                <p><strong>YES</strong> ‘All India Hajj and Umrah Tours Pvt. Ltd.</p>
															<!-- title bottom -->
								...
								<!-- bar -->
															<!-- circle bar -->
                                                            <p>Membership will be forfeited and the Agency will be Blacklisted in following situations</p>
                                                                <ol id="benifits-list">
                                                                    <li><h3>If Found making false promises to Guests</h3></li>
                                                                   <li><h3>If Found indulging in any Illegal or Immoral Activities.</h3></li>
                                                                   <li><h3>Overcharging the Guests for Our Tour Packages</h3></li>
                                                                   <li><h3>Trying to send Beggars or Job seekers in our Tour.</h3></li>
                                                                   <li><h3>Trying to Smuggle Illegal Products with Guests</h3></li>
                                                                   <li><h3>Doing any activity which will spoil the Name, Image and Reputation</h3></li>
                                                                   <li><h3>Not Clearing Company Dues on Time.</h3></li>
                                                                </ol>
