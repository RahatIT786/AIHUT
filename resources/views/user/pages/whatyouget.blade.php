					...
					<div class="elementor-widget-container">
						...
						<div class="tts text-left">
							<div class="ttin">
								...
								<!-- title middle -->
																<h2 class="txbdstitle sttwo hlight">What You Get <span></span> </h2>
															<!-- title bottom -->
								...
								<!-- bar -->
															<!-- circle bar -->
                                                            <p>Once your location & documentation is approved by our Management & Auditors and your Agency Deposit is paid we will provide you with the following…</p>
                                                                <ol id="benifits-list">
                                                                    <li><h3><span >Permission</span> to Operate Agency and take Umrah Bookings.</h3></li>
                                                                    <li><h3>All India Authorization <span>Certificate</span>.</h3></li>
                                                                    <li><h3>All India Authorization Photo ID Card for the Owner.</h3></li>
                                                                    <li><h3><span>50 Shoulder Bags</span> printed under your Company Name.</h3></li>
                                                                    <li><h3><span>100 Umrah Books</span> printed under your Company Name.</h3></li>
                                                                    <li><h3><span>100 Durood Books</span> printed under your Company Name.</h3></li>
                                                                    <li><h3><span>Flex Banner (6*4) </span> printed under your Company Name.</h3></li>
                                                                    <li><h3><span>Plugcard (16*12)</span> printed under your Company Name.</h3></li>
                                                                    <li><h3><span>Standee (6 ft)</span> printed under your Company Name.</h3></li>
                                                                    <li><h3> Official <span>Email Id & Website</span> Listing.</h3></li>
                                                                    <li><h3> Dedicated WhatsApp Group with our Senior Team Members from All Departments.</h3></li>
                                                                    <li><h3> Login & Access to our World Class Dynamic ERP Software to Manage Bookings.</h3></li>
                                                                    <li><h3> Dedicated Relationship Managers to answer all queries.</h3></li>
                                                                    <li><h3> Complete Inventory List of Airline Group PNRs.</h3></li>
                                                                    <li><h3> B2B Special Rates for All Religious Tour Packages.</h3></li>
                                                                    <li><h3> Exclusive Corporate Gift Hamper.</h3></li>
                                                                    <li><h3> Exclusive Table Standee of AIHUT.</h3></li>
                                                                    <li><h3> Organic Leads from your City & Area.</h3></li>
                                                                    <li><h3> Free Umrah Trip for One Owner of the Company Every Year.*</h3></li>
                                                                    <li><h3> Complete Partner and Staff Training in Delhi or Mumbai Office.</h3></li>
                                                                </ol>
