<div class="elementor-element elementor-element-533ab2b e-con-full e-flex e-con e-parent" data-id="533ab2b" data-element_type="container" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
				...
				<div class="elementor-widget-container">
					...
					<div class="tts text-left">
						<div class="ttin">
							...
							<!-- content -->
															<p>Copyright © <a href="https://rahatitsolutions.com/">RahatIT Solutions</a> All Right Reserved </p>		
		...
		<div class=" e-con-full e-flex e-con e-child" data-id="ccbe23b" data-element_type="container">
					...
					<div class="footer-menu">
						<!-- FOOTER COPYRIGHT MENU -->				
						 <ul id="menu-footer-menu" class="d-flex">
                            ...
                            <li id="menu-item-14448" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14448"><a href="{{route('whatdoweearn')}}">What do we Earn
							</a></li>
                            <li id="menu-item-14448" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14448"><a href="{{route('documentrequired')}}">Documents Required   </a></li>
						...
						<div class="footer-menu" style="border-top: 1px white solid;">
							<!-- FOOTER COPYRIGHT MENU -->				
							 <ul id="menu-footer-menu" class="d-flex">
								...
								<li id="menu-item-14449" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14449"><a href="{{route('contact')}}">Call Us Back</a></li>
							...
							<li id="menu-item-14448" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14448"><a href="{{route('termsandconditions')}}">Terms and Conditons</a></li>
							<li id="menu-item-14448" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14448"><a href="{{route('contact')}}">Contact Us </a></li>
                            <li id="menu-item-14448" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14448"><a href="{{route('aboutus')}}">About Us </a></li>
							 </ul> 
